...
import {useWindowDimensions,Text, Image, TouchableOpacity} from 'react-native';
...
import MyAngellist from '../screens/MyAngellist';
import MyAngellist2 from '../screens/MyAngellist2';
import MyAngel from '../screens/MyAngel';
import CustomDrawer from './CustomDrawer';
import Signtc from '../screens/Signtc';
import Signdp from '../screens/Signdp';
import Signcp from '../screens/Signcp';
import PrivacySetting from '../screens/PrivacySetting';
import CoockiesPrivacy from '../screens/CoockiesPrivacy';
...
{/* 
      <Stack.Screen
        ...
        options={{
          ...
          headerLeft: () => (
            <TouchableOpacity onPress={() => navigation.navigate('SignupPatholodgy')}>
            <Image
              source={icons.ArrowLeft}
              resizeMode="contain"
              style={{
...
<Stack.Screen
      ...
      />
        <Stack.Screen
          name="CoockiesPrivacy"
          component={CoockiesPrivacy}
          options={{headerShown: false}}
        />
        <Stack.Screen
        name="PrivacySetting"
      ...
      />
         <Stack.Screen
        name="MyAngellist"
        component={MyAngellist}
        options={{headerShown: false}}
      />
             <Stack.Screen
        name="MyAngellist2"
        component={MyAngellist2}
        options={{headerShown: false}}
      />
                 <Stack.Screen
        name="Signtc"
